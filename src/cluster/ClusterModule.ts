...
const serverGroupInput = (input: ServerGroup | undefined) => RequestInput.of(['cluster', input!.cluster], ['namespace', input!.namespace])
...
export const updateDeployment: Request<UpdateDeploymentParameters, Deployment> = {
    ...
    input: (input: UpdateDeploymentParameters | undefined) =>
        RequestInput.ofData(
...
export const restartDeployment: Request<RestartDeploymentParameters, Deployment> = {
    ...
    input: (input: RestartDeploymentParameters | undefined) =>
        RequestInput.ofData({ deployment: input!.deployment }, ['cluster', input!.group.cluster], ['namespace', input!.group.namespace]),
...
export const applySnapshot: Request<ApplySnapshotParameters, void> = {
    ...
    input: (input: ApplySnapshotParameters | undefined) =>
        RequestInput.ofData(
